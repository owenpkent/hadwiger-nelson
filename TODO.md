...
- [ ] **E17 n=17 door**: measured wall $>80$ cpu-days on this host (no mod=4096 sample part finished in 1,700 cpu-s); needs a qualitatively stronger prune (6-critical / Gallai-tree structure pushed inside the generator, or clique-cover lower bounds) or ~100x compute (~a hundred cores for a week). Do not launch the naive split here
