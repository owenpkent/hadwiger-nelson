...
- [ ] **E15-v2 / push past the plateau**: find an in-class chi-6 graph by violation-minimization from a NON-critical 6-chromatic seed (untried escape), and/or anneal at $n>40$ or with smarter moves to break the ~0.84-of-ceiling density plateau where a chi-6 witness would sit; a witness is a new object feeding the paper
