...
- [x] Reverse-engineer Polymath 510 and de Grey 1585 (e1i-e1t)
  ...
  - [ ] **L55 follow-up (i)**: can a planar UDG ($\omega\le3$) force two NON-adjacent vertices to the SAME color (realize relation $I$)? A forced-same gadget spliced to a differ-edge would build a clamp. SAT-decidable on small candidates; check whether $\omega\le3$ obstructs it
