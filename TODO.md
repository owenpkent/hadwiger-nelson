...
- [ ] **E18 finish the $n=16$ SAT census** (cheap, resumable): 5 of 8 $m=43$ branches outstanding; all other cells proved exhausted. Run `e18_enumerate --n 16 --m 43 --split 3:i` for the missing $i$, then `e18_merge.py` and `e18_n16_compare.py`. Expect 11,315/11,315 and verdict AGREE
