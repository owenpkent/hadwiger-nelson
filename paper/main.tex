...
enumerated orders $15$ and $16$, and the non-vacuity and ablation controls. A
certified version is possible in principle (the solver used can emit LRAT), and we
regard it as the natural next hardening rather than as a gap in the argument's
shape. Second, the two counting lemmas
