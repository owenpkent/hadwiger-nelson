...
- **Bridge minimum tightened to $\|B\| \leq 2000$ (L28)**: 700-bridge reduction (26%) on the L27 construction, Cadical UNSAT at $K = 2000$ (1687s). Bracket $(1500, 2000]$. Triggers F-profile shift from "97 always-saturating" to "43 always-saturating + 54 graded". L27's R5 rainbow-forcing conjecture is REFUTED by a $C_5$ counterexample (single-subset version) and likely false in the multi-subset Hall form too; the chi-6 forcing at $P_{510}^2$ is the L24 list-coloring obstruction manifesting through the specific algebraic structure of Polymath 510, not a generic graph-theoretic lemma. UDG realizability unchanged.
